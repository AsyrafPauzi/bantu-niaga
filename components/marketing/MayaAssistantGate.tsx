...
export function MayaAssistantGate() {
  return (
    <div className="flex min-h-[360px] flex-col items-center justify-center rounded-2xl border border-[#E5E0D8] bg-white p-8 text-center dark:border-hairline-dark dark:bg-panel-dark">
      ...
      <h2 className="text-lg font-bold text-ink dark:text-cream-100">
        Meet Maya — your Marketing helper
      </h2>
      <p className="mt-2 max-w-md text-sm text-ink-muted dark:text-cream-400">
        Ask about customers, segments, and promos in plain language. Draft
        broadcasts, coupons, and captions just by chatting. Adds 100 credits/mo
        to your shared AI pool (all assistants use the same balance).
      </p>
      <Link
        href="/marketplace"
      ...
      >
        Get Maya in Marketplace
      </Link>
      <p className="mt-3 text-xs text-ink-subtle dark:text-cream-500">
        Owner can activate from Marketplace → Marketing AI (Maya)
      </p>
    </div>
  );
}
