...
interface MayaAssistantMessageProps {
  content: string;
  className?: string;
}

/** Safe subset of Markdown for Maya assistant replies (lists, bold, internal links). */
export function MayaAssistantMessage({
  content,
  className,
}: MayaAssistantMessageProps) {
